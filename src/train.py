...
if __name__ == '__main__':
    ...
    net.conv_flow_block_list.requires_grad_(False)
    net.load_state_dict((torch.load('./pretrained/rmsteg.pth', map_location=f'cuda:{local_rank}')))
    ...
    for epoch_idx in range(1, args.train.epoch_num + 1):
        ...
        for data_idx, data in tqdm(enumerate(dataloader)):
            ...
            total_loss = steg_loss * 7.0 + ssim_loss * 0.1 + qr_loss * 16.0 + lpips_loss * 6.0
